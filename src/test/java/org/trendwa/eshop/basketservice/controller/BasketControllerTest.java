...
class BasketControllerTest {
    ...
    void testGetBasketByBuyerId() throws Exception {
        ...
        when(basketService.getBasketByBuyerId(buyerId)).thenReturn(basket);
    ...
    void testGetBasketByBuyerId_NotFound() throws Exception {
        String buyerId = "123";
        when(basketService.getBasketByBuyerId(buyerId)).thenThrow(new CustomerBasketNotFoundException("Basket not found"));
